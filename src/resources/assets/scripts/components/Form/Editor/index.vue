  ...
  >
    ...
    <div
      class="
        ...
        gap-y-[8px]
        border-t border-b border-[#333333]
        py-[14px]
        mb-[50px]
        max-w-full
      "
    >
      ...
      <div class="lg:pr-[20px]">
        <input
          type="text"
          name="title"
          class="border border-[#9b9b9b] p-[14px] w-full"
          required
        />
      </div>
      ...
      <div class="lg:pr-[20px]">
        <div
          v-if="editor"
          class="toolbar sm:flex gap-[4px] overflow-x-auto max-w-full hidden"
        >
          <button
            class="w-[28px] h-[28px] p-[6px]"
          ...
          >
            ...
            >
              <path
                id="_x30_6.Bold"
                d="m403.321 235.911c16.996-20.761 27.479-46.08 30.134-72.779 8.236-85.157-58.583-157.132-141.82-157.132h-225.424c-8.284 0-15 6.716-15 15v59.286c0 8.284 6.716 15 15 15h38.426v321.429h-38.426c-8.284 0-15 6.716-15 15v59.285c0 8.284 6.716 15 15 15h236.473c79.018 0 149.71-57.757 157.366-136.607 5.291-54.074-18.292-102.746-56.729-133.482zm-209.632-140.625h97.946c29.587 0 53.571 23.985 53.571 53.571s-23.985 53.571-53.571 53.571h-97.946zm97.946 321.428h-97.946v-125h97.946c34.518 0 62.5 27.982 62.5 62.5s-27.982 62.5-62.5 62.5z"
              />
            </svg>
          </button>
          <button
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g id="_x33_5.Heading1">
                <path
                  d="m283.7 352v27.2c-.1 10.1-5.5 15.7-15.6 15.7-26.7.1-53.4.1-80 0-9.8 0-15.3-5.5-15.4-15.4-.1-9.2-.1-18.4 0-27.6.1-8.6 4.1-12.5 12.8-12.6h14.7v-55.3h-110.6v55.4h14.7c8.7.1 12.7 4 12.8 12.6.1 9.2.1 18.4 0 27.6-.1 9.9-5.5 15.4-15.4 15.4-26.7 0-53.4 0-80 0-10.1 0-15.5-5.5-15.6-15.7-.1-9.1-.1-18.2-.1-27.3 0-8.1 4.4-12.6 12.5-12.7 5-.1 10 0 14.9 0v-166.9c-5.5 0-10.6.1-15.7 0-7.3-.1-11.6-4.5-11.7-11.7-.1-9.6-.1-19.2 0-28.8.1-9.3 5.7-14.8 15.1-14.8h83.3c8.4 0 12.5 4 12.6 12.4.1 10.2.1 20.3 0 30.5-.1 8.4-4.1 12.5-12.5 12.5-5 0-9.9 0-14.9 0v55.5h110.4v-55.5c-5 0-9.9 0-14.9 0-8.4-.1-12.4-4.1-12.5-12.5-.1-10.2-.1-20.3 0-30.5.1-8.4 4.2-12.4 12.6-12.4h83.3c9.4 0 15 5.5 15.1 14.8.1 9.6.1 19.2 0 28.8-.1 7.3-4.4 11.6-11.7 11.7-5.1.1-10.3 0-15.7 0v166.9h14.9c8.1.2 12.5 4.6 12.6 12.7z"
                />
                <path
                  d="m349.7 395h139c9.6 0 17.4-7.8 17.4-17.4v-34.7c0-9.6-7.8-17.4-17.4-17.4h-34.7v-191.1c0-9.6-7.8-17.4-17.4-17.4h-52.1c-6.6 0-12.6 3.7-15.5 9.6l-17.4 34.7c-4.3 8.6-.8 19 7.8 23.3 2.4 1.2 5.1 1.8 7.7 1.8h17.4v139h-34.7c-9.6 0-17.4 7.8-17.4 17.4v34.7c-.1 9.7 7.7 17.5 17.3 17.5z"
                />
              </g>
            </svg>
          </button>
          ...
          >
            ...
            >
              <g id="_x34_9.List">
                <path
                  d="m491 134.75h-313.75c-8.284 0-15-6.716-15-15v-40c0-8.284 6.716-15 15-15h313.75c8.284 0 15 6.716 15 15v40c0 8.284-6.716 15-15 15z"
                />
                <path
                  d="m491 291h-313.75c-8.284 0-15-6.716-15-15v-40c0-8.284 6.716-15 15-15h313.75c8.284 0 15 6.716 15 15v40c0 8.284-6.716 15-15 15z"
                />
                <path
                  d="m491 447.25h-313.75c-8.284 0-15-6.716-15-15v-40c0-8.284 6.716-15 15-15h313.75c8.284 0 15 6.716 15 15v40c0 8.284-6.716 15-15 15z"
                />
                <path
                  d="m52.875 209.125c-25.888 0-46.875 20.987-46.875 46.875 0 25.888 20.987 46.875 46.875 46.875 25.888 0 46.875-20.987 46.875-46.875 0-25.888-20.987-46.875-46.875-46.875z"
                />
                <path
                  d="m52.875 365.375c-25.888 0-46.875 20.987-46.875 46.875 0 25.888 20.987 46.875 46.875 46.875 25.888 0 46.875-20.987 46.875-46.875 0-25.888-20.987-46.875-46.875-46.875z"
                />
                <path
                  d="m52.875 52.875c-25.888 0-46.875 20.987-46.875 46.875 0 25.888 20.987 46.875 46.875 46.875 25.888 0 46.875-20.987 46.875-46.875 0-25.888-20.987-46.875-46.875-46.875z"
                />
              </g>
            </svg>
          </button>
      ...
      <div class="lg:pr-[20px]">
        <button
          type="button"
          @click="add()"
          class="flex w-full items-center mb-[14px]"
        >
        ...
        <div class="text-[#a7a7a7] mb-[26px]">
          * 전체 파일의 총 용량은 50MB 이내여야 합니다. 파일은 최대 5개까지 첨부
          가능합니다.
        </div>
        <div
          class="p-[24px] bg-[#f5f5f5] grid gap-y-[18px] relative min-h-[100px]"
        >
          <component
          ...
          >
            ...
            <div
              class="bg-black opacity-10 absolute left-0 top-0 right-0 bottom-0"
            ></div>
          </div>
        </div>
      </div>
    ...
    <div class="flex justify-center gap-x-[5px] text-[16px]">
      <button class="btn-lochmara w-[140px] py-[15px]" @click.prevent="submit">
        등록
      </button>
