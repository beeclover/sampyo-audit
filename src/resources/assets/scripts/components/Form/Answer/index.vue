<template>
  <div>
    ...
    <div v-if="editor" class="toolbar sm:flex gap-[4px] hidden">
      ...
      <div class="w-[28px] h-[28px] p-[6px] cursor-pointer" @click="editor.chain().focus().toggleItalic().run()" :class="{ 'is-active': editor.isActive('italic') }">
      ...
      <div class="w-[28px] h-[28px] p-[4px] cursor-pointer" @click="editor.chain().focus().toggleStrike().run()" :class="{ 'is-active': editor.isActive('strike') }">
      ...
      <div class="w-[32px] h-[28px] px-[4px] cursor-pointer" @click="editor.chain().focus().toggleHeading({ level: 1 }).run()" :class="{ 'is-active': editor.isActive('heading', { level: 1 }) }">
      ...
      <div class="w-[32px] h-[28px] px-[4px] cursor-pointer" @click="editor.chain().focus().toggleHeading({ level: 2 }).run()" :class="{ 'is-active': editor.isActive('heading', { level: 2 }) }">
      ...
      <div class="w-[28px] h-[28px] p-[6px] cursor-pointer" @click="editor.chain().focus().setParagraph().run()" :class="{ 'is-active': editor.isActive('paragraph') }">
      ...
      <div class="w-[28px] h-[28px] p-[4px] cursor-pointer" @click="editor.chain().focus().toggleBulletList().run()" :class="{ 'is-active': editor.isActive('bulletList') }">
      ...
      <div class="w-[28px] h-[28px] p-[4px] cursor-pointer" @click="editor.chain().focus().toggleOrderedList().run()" :class="{ 'is-active': editor.isActive('orderedList') }">
      ...
      <div class="w-[28px] h-[28px] p-[4px] cursor-pointer" @click="editor.chain().focus().toggleCodeBlock().run()" :class="{ 'is-active': editor.isActive('codeBlock') }">
      ...
      <div class="w-[28px] h-[28px] p-[6px] cursor-pointer" @click="editor.chain().focus().toggleBlockquote().run()" :class="{ 'is-active': editor.isActive('blockquote') }">
