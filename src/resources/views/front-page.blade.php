...
<div class="flex flex-col justify-center relative min-h-screen">
  <div class="container max-w-[calc(960px+2rem)] relative z-10">
    ...
    <div class="grid grid-cols-3 gap-x-[30px] h-[300px]">
      <a href="{!! get_the_permalink(26) !!}" class="rounded-[4px] bg-[#ebebeb] hover:bg-[#0086ce] bg-opacity-[0.9] grid place-content-center text-black hover:text-white transition-all">
      ...
      <a href="{!! get_post_type_archive_link('report') !!}" class="rounded-[4px] bg-[#ebebeb] hover:bg-[#0086ce] bg-opacity-[0.9] grid place-content-center text-black hover:text-white">
        <div class="flex flex-col items-center">
          <div class="w-[60px] mb-[44px]">
